...
**[⇧ Deploy it yourself](https://render.com/deploy?repo=https://github.com/Akgithub2028/05-urban-demand-warehouse)** — one click builds `render.yaml` on Render's free tier: the allocation API over a two-month warehouse build. No card, no configuration.
